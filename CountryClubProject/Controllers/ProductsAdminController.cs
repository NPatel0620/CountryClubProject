...
namespace CountryClubProject.Controllers
{
    ...
    public class ProductsAdminController : Controller
    {
        ...
        public ProductsAdminController(CountryClubDbContext context, IHostingEnvironment env )
        {
            _context = context;
            _env = env;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,ClubType,Brand,Model,Description,Price,Image")] Product product)
        {
        ...
        public async Task<IActionResult> Edit(int id, Product product, Microsoft.AspNetCore.Http.IFormFile imageFile)
        {
            ...
            //Double check that this code is placed and put in correctly!!!!!!!!!!!!!!!!!!!!!!
